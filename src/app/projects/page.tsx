      ...
      <main className="flex-1 overflow-y-auto px-10 py-8 pb-16 relative bg-bg">
        ...
        <div className="grid grid-cols-3 gap-4">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-panel border border-line rounded-xl p-5 cursor-pointer transition-all duration-200 hover:border-line-2 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.3)] relative overflow-hidden group"
            >
              <div
